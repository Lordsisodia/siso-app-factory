...
> **Path Update (Nov 20, 2025):** UI components now live at `packages/platform/ui/...`. Domain templates like bike-rental/tour-guides reside in `templates/*`.
...
### **packages/platform/ui/** - Core UI Library

**Organized into**:

#### **primitives/** (50+ categories)
Location: `packages/platform/ui/src/primitives/`
...
**1. SISO App Factory packages/** (PRIMARY - use first)
   ```
   Check: siso-app-factory/packages/platform/ui/src/primitives/
   Check: siso-app-factory/packages/platform/ui/src/patterns/
...
```bash
# Check UI primitives
packages/platform/ui/src/primitives/cards/
packages/platform/ui/src/primitives/pricing/

# Check patterns
packages/platform/ui/src/patterns/sections/*pricing*
...
Effort: 4 hours
Base: Use packages/platform/ui/primitives/cards/Card.tsx as foundation
```
...
2. `packages/platform/ui/` - Core UI primitives
...
**Use This Order**:
1. `packages/platform/ui/` - Core UI primitives (adapt from here)
...
- 40 from packages/restaurants + packages/platform/ui (0.5hr each = 20hr)
...
- 30 from packages/platform/ui (1hr each = 30hr)
...
Explore: packages/platform/ui/src/primitives/
Explore: packages/platform/ui/src/patterns/
...
1. Search siso-app-factory/packages/platform/ui first
