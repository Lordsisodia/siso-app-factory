      ...
      "properties": {
        ...
        "ui": {
          ...
          "items": {
            ...
            "properties": {
              "name": { "type": "string" },
              "from": { "type": "string", "description": "Library path e.g. packages/platform/ui/src/primitives/buttons/PrimaryButton.tsx" },
...
components:
  pages:
    - name: Home
      ...
      layout: marketing
      sections:
        - component: packages/platform/ui/src/primitives/heroes/hero-fullscreen/component.tsx
          props:
            title: "Bali Bites"
  ...
  ui:
    - name: PrimaryButton
      from: packages/platform/ui/src/primitives/buttons/PrimaryButton.tsx
      as: PrimaryButton
