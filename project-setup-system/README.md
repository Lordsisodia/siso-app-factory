...
│
├── 🧠 CONTEXT (grouped folders)
│   ├── README.md                               # Directory map + loading guidance
│   ├── 00-vision/
...
│   │   ├── AI-FRAMEWORK-RESEARCH-FINDINGS.md   # Planning + reasoning patterns
│   │   ├── DEEP-RESEARCH-CONTEXT.md            # Research methodologies
│   │   ├── DEEP-RESEARCH-BRIEF-CODE-EXECUTION.md    # 36 code-execution questions
│   │   ├── DEEP-RESEARCH-FINDINGS-CODE-EXECUTION.md # AI coder best practices
│   │   └── CONTEXT-ENGINEERING-REPOSITORY-DEEP-DIVE.md # Memory + RAG playbook
│   ├── 20-implementation/
│   │   ├── CODEX-IMPLEMENTATION-DESIGN.md      # buildplan.yaml schema
│   │   └── COMPLETE-SYSTEM-CONTEXT-FOR-AI.md   # Condensed system overview
│   └── 30-special-topics/
│       └── UI-BEST-PRACTICES/
│           └── UI-NON-NEGOTIABLES.md           # Mandatory UI checklist & heuristics
│
├── 📚 KNOWLEDGE BASES
│   └── RESTAURANT-KNOWLEDGE-BASE.md     # Restaurant industry data
│
├── 🧱 ARCHITECTURE TEMPLATES
│   ├── TEMPLATE-ARCHITECTURE.md         # Canonical repo structure
│   ├── DOMAIN-DRIVEN-LAYOUT.md          # Per-domain/page deep layout
│   └── AI-NATIVE-MULTI-AGENT-FRAMEWORK.md
│
└── 📊 ROADMAP
    └── SYSTEM-ROADMAP.md                # Combined vision, gaps, release notes
```
...
**2. Review the Vision**:
```bash
cat .siso/project-setup-system/context/00-vision/UNIVERSAL-PRD-FRAMEWORK-VISION.md
```
...
6. **PRD-SETUP-CHECKLIST.md** - Final gate for verifying every requirement/validation item
7. **scripts/scaffold-domain.ts** (`pnpm scaffold:domain`) - Enforces the canonical `src/domains` layout
8. **scripts/update-build-checklists.ts** (`pnpm update:build-checklists`) - Syncs the Master Build Plan’s dynamic checklists from `buildplan.yaml`

### Vision & Research:
7. **context/00-vision/UNIVERSAL-PRD-FRAMEWORK-VISION.md** - Why this exists
8. **context/10-research/DEEP-RESEARCH-FINDINGS-CODE-EXECUTION.md** - AI coder best practices
9. **context/20-implementation/CODEX-IMPLEMENTATION-DESIGN.md** - buildplan.yaml schema

### Integration:
10. **integrations/SUPABASE-INTEGRATION-GUIDE.md** - Database patterns
11. **integrations/CLERK-INTEGRATION-GUIDE.md** - Auth patterns
12. **integrations/CONFIG-DRIVEN-THEMING-GUIDE.md** - Theming system
...
- Run `tools/core/generate-metadata.cjs` to rebuild catalog
- Check that AI is searching with `tools/core/ai-search.cjs`
