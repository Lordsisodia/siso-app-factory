...
> Need the full story? See `README.md` for the comprehensive onboarding flow. This file just lists the shortest path to bootstrap a new project and tell your AI what to do.
...
| `PRD-SETUP-CHECKLIST.md` | Phase completion tracker (copy into each project) |
