...
const MISC_DIR = path.join(__dirname, '../../../packages/platform/ui/src/primitives/misc')
const PATTERNS_DIR = path.join(__dirname, '../../../packages/platform/ui/src/patterns')
const PRIMITIVES_DIR = path.join(__dirname, '../../../packages/platform/ui/src/primitives')
