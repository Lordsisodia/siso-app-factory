...
const DEST_ROOT = path.join(__dirname, '../../../packages/platform/ui/src/primitives')
...
Usage:
  node tools/core/component-import/bulk-import.cjs <library-name>
  node tools/core/component-import/bulk-import.cjs --all

Examples:
  node tools/core/component-import/bulk-import.cjs shadcn-ui
  node tools/core/component-import/bulk-import.cjs magic-ui
  node tools/core/component-import/bulk-import.cjs --all
...
Available libraries:
  ...
  if (args[0] === '--all') {
    ...
    require('../generate-metadata.cjs').generateCatalog()
