...
**File:** `docs/catalog/components-and-features.json` (~8MB)
...
```bash
# Add new library
node tools/core/component-import/bulk-import.cjs new-library-name
...
1. **Add more components:** Run `node tools/core/component-import/bulk-import.cjs --all` (adds 2200+ more)
