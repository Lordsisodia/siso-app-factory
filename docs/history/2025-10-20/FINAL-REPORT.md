...
│
├── docs/
│   ├── catalog/components-and-features.json                       # Master AI Catalog (1.5MB)
│   └── imports/                              # Staging area
│
├── tools/
│   ├── generate-metadata.cjs                  # Catalog generator
│   ├── ai-search.cjs                          # AI search engine
│   ├── bulk-import.cjs                        # Bulk importer
│   └── recategorize-misc.cjs                  # Recategorization tool
│
...
3. **Bulk Importer** (`tools/core/component-import/bulk-import.cjs`)
   - Mass component migration
   - Auto-categorization
   - Auto-metadata generation
   - Imported 1,117 files in one run

4. **Recategorization Tool** (`tools/core/component-import/recategorize-misc.cjs`)
...
**File:** `docs/catalog/components-and-features.json`
**Size:** 1.5MB
**Contains:**
...
// Search
const { searchComponents, searchFeatures } = require('./tools/core/ai-search.cjs')
...
- Single source of truth (catalog/components-and-features.json)
- Natural language queries
- Intelligent ranking
- Context-aware recommendations
- Explains reasoning
