...
`;
export function ChronicleButton({ text, onClick, hoverColor = "#a594fd", width = "160px", outlined = false, outlinePaddingAdjustment = "2px", borderRadius = "8px", outlinedButtonBackgroundOnHover = "transparent", customBackground = "#ffffff", customForeground = "#111014", hoverForeground = "#111014", fontFamily, className = "", }) {
    React.useEffect(() => {
    ...
    return (_jsxs("button", { type: "button", className: `chronicleButton${outlined ? " outlined" : ""} ${className}`.trim(), onClick: onClick, style: buttonStyle, children: [_jsx("span", { children: _jsx("em", { children: text }) }), _jsx("span", { children: _jsx("em", { children: text }) })] }));
}
