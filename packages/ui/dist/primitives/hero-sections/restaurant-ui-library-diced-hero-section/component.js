...
`;
function useStyleInjection(id, css) {
    React.useEffect(() => {
...
export function DicedHeroSection({ topText, mainText, subMainText, buttonText, slides, onMainButtonClick, onGridImageHover, onGridImageClick, topTextStyle, mainTextStyle, subMainTextStyle, buttonStyle = {}, componentBorderRadius = "0px", backgroundColor, separatorColor = "#005baa", maxContentWidth = "1536px", mobileBreakpoint = 1000, fontFamily = "inherit", isRTL = false, className, }) {
    ...
    const isRTLCheck = React.useCallback((text) => {
        return /[\u0590-\u05FF\u0600-\u06FF\u0700-\u074F]/.test(text);
    }, []);
    const getGradientStyle = React.useCallback((gradient) => {
        if (!gradient)
            return {};
        return {
    ...
    return (_jsxs("main", { ref: containerRef, className: cn("diced-hero-section", className), style: {
            ...
            gap: "2rem",
                    ...
                    gap: "1.5rem",
                }, children: [_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "1rem" }, children: [_jsx(motion.span, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5 }, style: {
                                    ...topTextStyle,
                                    ...
                                    fontWeight: 600,
                                }, children: topText }), _jsx(motion.h1, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.1 }, style: {
                                    ...mainTextStyle,
                                    ...
                                    }, children: mainText }) }), _jsx(motion.hr, { initial: { width: 0 }, animate: { width: "6.25rem" }, transition: { duration: 0.5, delay: 0.2 }, style: {
                                    height: "0.25rem",
                                    ...
                                    borderRadius: "999px",
                                    width: "6.25rem",
                                } }), _jsx(motion.p, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.3 }, style: {
                                    ...subMainTextStyle,
                                    ...
                                    lineHeight: 1.6,
                                }, children: subMainText })] }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.5, delay: 0.4 }, style: {
                            display: "flex",
                            justifyContent: isMobile ? "center" : isRTL ? "flex-end" : "flex-start",
                        }, children: _jsx(ChronicleButton, { text: buttonText, onClick: onMainButtonClick, hoverColor: buttonStyle?.hoverColor, hoverForeground: buttonStyle?.hoverForeground ?? "#ffffff", borderRadius: buttonStyle?.borderRadius, width: buttonStyle?.width, outlined: buttonStyle?.outlined, outlinePaddingAdjustment: buttonStyle?.outlinePaddingAdjustment, outlinedButtonBackgroundOnHover: buttonStyle?.outlinedButtonBackgroundOnHover, customBackground: buttonStyle?.backgroundColor ?? "var(--diced-hero-section-button-bg)", customForeground: buttonStyle?.color ?? "var(--diced-hero-section-button-fg)", fontFamily: fontFamily }) })] }), _jsx("div", { style: {
                    flex: 1,
                    display: "flex",
                    flexDirection: "column",
                    ...
                    paddingRight: isMobile ? 0 : isRTL ? "2rem" : 0,
                        ...
                        width: "100%",
                        aspectRatio: "1 / 1",
                    }, children: gridSlides.map((slide, index) => (_jsx("div", { style: {
                            position: "relative",
                            width: "100%",
                            paddingBottom: "100%",
                            overflow: "hidden",
                            borderRadius: "20px",
                        }, children: _jsx("img", { src: slide.image, alt: slide.title || `Slide ${index + 1}`, className: cn("diced-hero-warped-image", CORNER_CLASSES[index % CORNER_CLASSES.length]), style: {
                                position: "absolute",
                                top: 0,
                                left: 0,
                                width: "100%",
                                ...
                                objectFit: "cover",
                                cursor: "pointer",
                            }, onClick: () => onGridImageClick?.(index), onMouseEnter: () => onGridImageHover?.(index) }) }, `${slide.title}-${index}`))) }) })] }));
}
