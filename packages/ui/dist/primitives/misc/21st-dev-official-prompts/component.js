...
export const promptOptions = [
    {
        ...
        action: "copy",
        icon: (_jsx(Icons.boltLogo, { className: "min-h-[22px] min-w-[22px] max-h-[22px] max-w-[22px]" })),
    },
    {
        id: "separator1",
        type: "separator",
    },
    {
        ...
        action: "copy",
        icon: (_jsx(Icons.cursorIcon, { className: "min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" })),
    },
    {
        type: "option",
        ...
        action: "copy",
        icon: (_jsx(Icons.lovableLogo, { className: "min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" })),
    },
    {
        type: "option",
        id: PROMPT_TYPES.V0,
        ...
        action: "copy",
        icon: (_jsx(Icons.v0Logo, { className: "min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" })),
    },
    {
        type: "option",
        ...
        action: "copy",
        icon: (_jsx(Icons.replit, { className: "min-h-[22px] min-w-[22px] max-h-[22px] max-w-[22px]" })),
    },
    {
        type: "option",
        ...
        action: "copy",
        icon: (_jsx(Icons.magicPatterns, { className: "min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" })),
    },
    {
        type: "option",
        ...
        action: "copy",
        icon: (_jsx(Icons.sitebrewLogo, { className: "min-h-[18px] min-w-[18px] max-h-[18px] max-w-[18px]" })),
    },
];
export const getComponentInstallPrompt = ({ promptType, codeFileName, demoCodeFileName, code, demoCode, registryDependencies, npmDependencies, npmDependenciesOfRegistryDependencies, tailwindConfig, globalCss, promptRule, userAdditionalContext, indexCss, }) => {
    ...
    if (promptType === PROMPT_TYPES.MAGIC_PATTERNS) {
      ...
      ` +
        ...
        ${Object.entries(registryDependencies)
                        .map(([fileName, fileContent]) => endent `
            \`\`\`tsx
            ${fileName}
            ${fileContent}
            \`\`\`
    ...
    if (allDependencies.length) {
        const dependenciesPrompt = promptType === PROMPT_TYPES.REPLIT
