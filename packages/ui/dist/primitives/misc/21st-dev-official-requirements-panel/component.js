...
function isStylesAction(details) {
    return details?.reason === "styles";
}
export function RequirementsPanel({ className, activeFile, }) {
    ...
    return (_jsx("div", { className: cn("fixed bottom-4 left-1/2 -translate-x-1/2 z-50 max-w-xl w-full", className), children: _jsxs("div", { className: "flex items-center justify-between p-3 bg-background border border-border rounded-2xl shadow-md", children: [_jsxs("div", { className: "flex items-start gap-2", children: [_jsx(AlertCircle, { className: "h-4 w-4 text-yellow-500 flex-shrink-0" }), _jsxs("div", { className: "flex flex-col gap-1", children: [_jsx("span", { className: "text-xs font-medium", children: "AI Suggestion" }), _jsx("span", { className: "text-xs", children: message })] })] }), _jsx(Button, { variant: "outline", size: "sm", onClick: handleResolve, className: "flex items-center gap-1", children: _jsx("span", { children: "Mark as resolved" }) })] }) }));
}
