...
export function ComicText({ children, className, style, fontSize = 5, }) {
    ...
    return (_jsx(motion.div, { className: cn("text-center select-none", className), style: {
        ...
        `,
            ...
            ...style,
        }, initial: { opacity: 0, scale: 0.8, rotate: -2 }, animate: { opacity: 1, scale: 1, rotate: 0 }, transition: {
            duration: 0.6,
