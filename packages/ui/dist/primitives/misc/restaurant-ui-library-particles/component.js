...
const Particles = ({ className = "", quantity = 100, staticity = 50, ease = 50, size = 0.4, refresh = false, color = "#ffffff", vx = 0, vy = 0, }) => {
    ...
    return (_jsx("div", { className: cn("pointer-events-none", className), ref: canvasContainerRef, "aria-hidden": "true", children: _jsx("canvas", { ref: canvasRef, className: "size-full" }) }));
};
export { Particles };
