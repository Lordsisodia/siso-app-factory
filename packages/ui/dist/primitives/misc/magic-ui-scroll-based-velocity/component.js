...
function ScrollVelocityRowImpl({ children, baseVelocity = 5, direction = 1, className, velocityFactor, ...props }) {
    ...
    return (_jsx("div", { ref: containerRef, className: cn("w-full overflow-hidden whitespace-nowrap", className), ...props, children: _jsx(motion.div, { className: "inline-flex transform-gpu items-center will-change-transform select-none", style: { x }, children: Array.from({ length: numCopies }).map((_, i) => (_jsx("div", { ref: i === 0 ? blockRef : null, "aria-hidden": i !== 0, className: "inline-flex shrink-0 items-center", children: children }, i))) }) }));
}
