...
`;
export function generateSandpackFiles({ demoComponentNames, componentSlug, relativeImportPath, code, demoCode, theme, css, customTailwindConfig, customGlobalCss, }) {
...
export function generateBundleFiles({ demoComponentNames, componentSlug, relativeImportPath, code, demoCode, css, customTailwindConfig, customGlobalCss, }) {
    const pathParts = relativeImportPath.split("/");
    const isBlocksRegistry = pathParts[pathParts.length - 1] === "blocks";
    const appTsxContent = isBlocksRegistry
        ? `
