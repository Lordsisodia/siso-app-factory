...
const CarHero: React.FC<CarHeroProps> = ({ searchTerm, setSearchTerm }) => {
  return (
    <section className="pt-24 pb-16 bg-gradient-to-r from-primary/90 to-primary text-primary-foreground relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?ixlib=rb-4.0.3&auto=format&fit=crop&q=80')] bg-cover bg-center opacity-20"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-primary-foreground/80 text-lg mb-8">
            Browse our meticulously maintained collection of premium vehicles. From iconic sports cars to elegant luxury sedans, we offer an unmatched driving experience for every occasion.
          </p>
